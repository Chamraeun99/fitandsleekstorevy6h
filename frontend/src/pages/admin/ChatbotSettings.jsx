  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div
          className="relative overflow-hidden rounded-3xl border border-slate-200/70 dark:border-slate-700/70 p-6 md:p-8 mb-6 md:mb-8 bot-enter"
          style={{
            background:
              mode === "dark"
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div className="flex items-start gap-4">
              <span
                ...
                style={{
                  background: `linear-gradient(135deg, ${primaryColor}, ${mode === "dark" ? "#0ea5e9" : "#111827"})`,
                }}
              >
              ...
              <div>
                ...
                <h1 className="mt-3 text-2xl md:text-3xl font-semibold text-slate-900 dark:text-white">Chatbot Settings</h1>
                <p className="text-sm md:text-base text-slate-600 dark:text-slate-300 mt-1">
                  Configure a modern chatbot experience with cleaner greetings and social channel routing.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3 min-w-[220px]">
              <div className="rounded-2xl border border-white/30 dark:border-white/10 bg-white/70 dark:bg-white/5 px-4 py-3">
                ...
                <p className="text-lg font-semibold text-slate-900 dark:text-white">{form.enabled ? "Enabled" : "Disabled"}</p>
              </div>
              <div className="rounded-2xl border border-white/30 dark:border-white/10 bg-white/70 dark:bg-white/5 px-4 py-3">
                <p className="text-xs text-slate-600 dark:text-slate-400">Connected</p>
                <p className="text-lg font-semibold text-slate-900 dark:text-white">{socialLinks.length} Links</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden shadow-[0_10px_28px_rgba(15,23,42,0.08)] dark:shadow-[0_14px_40px_rgba(2,6,23,0.45)] backdrop-blur-xl bot-enter" style={{ animationDelay: "80ms" }}>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <span className={"inline-block h-5 w-5 rounded-full bg-white dark:bg-slate-100 shadow-sm transition-transform duration-300 " + (form.enabled ? "translate-x-6" : "translate-x-1")} />
                </button>
              </div>
          ...
          <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden shadow-[0_10px_28px_rgba(15,23,42,0.08)] dark:shadow-[0_14px_40px_rgba(2,6,23,0.45)] backdrop-blur-xl bot-enter" style={{ animationDelay: "160ms" }}>
            <div className="bg-white/90 dark:bg-slate-900/90 border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={openAdd}
                className="inline-flex items-center gap-1.5 px-3.5 py-2 text-white text-sm font-medium rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
          ...
          <div className="flex items-center gap-3 bot-enter" style={{ animationDelay: "220ms" }}>
            <button
              type="submit"
              disabled={saving}
              className="px-6 py-2.5 rounded-xl text-white font-semibold disabled:opacity-60 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
              style={{ backgroundColor: primaryColor }}
            >
              {saving ? "Saving…" : "Save settings"}
            </button>
            {message && (
              <span className={"text-sm font-medium px-3 py-1.5 rounded-full border " + (message.startsWith("Saved") ? "text-emerald-600 border-emerald-200 bg-emerald-50 dark:bg-emerald-500/10 dark:border-emerald-400/30" : "text-red-500 border-red-200 bg-red-50 dark:bg-red-500/10 dark:border-red-400/30") }>
                {message}
              </span>
            )}
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 w-full max-w-2xl p-6 bot-modal-enter">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 py-2.5 text-white rounded-xl font-semibold disabled:opacity-50 transition-all duration-200 hover:-translate-y-0.5"
                style={{ backgroundColor: primaryColor }}
              >
